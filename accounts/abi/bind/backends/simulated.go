...
func (b *SimulatedBackend) callContract(ctx context.Context, call xpayments.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
