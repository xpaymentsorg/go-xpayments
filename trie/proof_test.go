...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *xpsdb.MemDatabase {
	var provers []func(key []byte) *xpsdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *xpsdb.MemDatabase {
		proof := xpsdb.NewMemDatabase()
