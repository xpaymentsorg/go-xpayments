...
var _ xpsdb.Segment = (*Segment)(nil)
...
type Segment struct {
	...
	IteratorFunc func() xpsdb.SegmentIterator
}
...
func (m *Segment) Iterator() xpsdb.SegmentIterator { return m.IteratorFunc() }

var _ xpsdb.MutableSegment = (*MutableSegment)(nil)
...
type SegmentOpener struct {
	...
	OpenSegmentFunc      func(table, name, path string) (xpsdb.Segment, error)
}
...
func (m *SegmentOpener) OpenSegment(table, name, path string) (xpsdb.Segment, error) {
...
type SegmentCompactor struct {
	CompactSegmentFunc   func(ctx context.Context, table string, s *xpsdb.LDBSegment) (xpsdb.Segment, error)
	UncompactSegmentFunc func(ctx context.Context, table string, s xpsdb.Segment) (*xpsdb.LDBSegment, error)
}

func (m *SegmentCompactor) CompactSegment(ctx context.Context, table string, s *xpsdb.LDBSegment) (xpsdb.Segment, error) {
	return m.CompactSegmentFunc(ctx, table, s)
}

func (m *SegmentCompactor) UncompactSegment(ctx context.Context, table string, s xpsdb.Segment) (*xpsdb.LDBSegment, error) {
