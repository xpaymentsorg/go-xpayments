...
func TestFileSegment_Get(t *testing.T) {
	t.Run("OK", func(t *testing.T) {
		...
		enc := xpsdb.NewFileSegmentEncoder(path)
		...
		s := xpsdb.NewFileSegment("test", path)
...
// Ensure xpsdb.FileSegment can fetch keys using randomized test data.
...
// EncodeToFileSegment encodes a set of key/value pairs to an xpsdb.FileSegment at path.
