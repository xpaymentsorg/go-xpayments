...
type Downloader struct {
	...
	// Channels
	headerCh      chan dataPack        // [xps/62] Channel receiving inbound block headers
	bodyCh        chan dataPack        // [xps/62] Channel receiving inbound block bodies
	receiptCh     chan dataPack        // [xps/63] Channel receiving inbound receipts
	bodyWakeCh    chan bool            // [xps/62] Channel to signal the block body fetcher of new tasks
	receiptWakeCh chan bool            // [xps/63] Channel to signal the receipt fetcher of new tasks
	headerProcCh  chan []*types.Header // [xps/62] Channel to feed the header processor new tasks

	// for stateFetcher
	stateSyncStart chan *stateSync
	trackStateReq  chan *stateReq
	stateCh        chan dataPack // [xps/63] Channel receiving inbound node state data
...
func (d *Downloader) syncWithPeer(p *peerConnection, hash common.Hash, td *big.Int) (err error) {
	...
	log.Info("Synchronising with the network", "peer", p.id, "xps", p.version, "head", hash, "td", td, "mode", d.mode)
