...
func DefaultGenesisBlock() *Genesis {
	...
	alloc, ok := new(big.Int).SetString("5000000000000000000000000000", 10)
	if !ok {
		panic("failed to parse big.Int string")
	}
	var extra = []byte("xPayments")
	return &Genesis{
		...
		Signers: []common.Address{
			common.HexToAddress("0x6C668FA29735D7b78f295EC38ff2495db0Cc6a16"),
			common.HexToAddress("0x6eEa0e70D8497468F46519EF62ABd1f23576774D"),
			common.HexToAddress("0x3Bf4625bF7330c2776F5D27ca9BC0FfbE233659a"),
			common.HexToAddress("0x030777f39809e19f189B4d904017Dc173B1Ad6E2"),
			common.HexToAddress("0x85e625cEc0F5302F7163F873fF5FaA4A86aa00A6"),
		},
...
// DeveloperGenesisBlock returns the 'gpay --dev' genesis block. Note, this must
...
// LocalGenesisBlock returns the 'gpay --local' genesis block.
