...
var (
	MainnetGenesisHash = common.HexToHash("0xe10a8cd0dabf4ddc6f4f0e74f5eea7d111df96be65cd9c960c3e7aeb98ef584c")
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		ConstantinopleBlock: big.NewInt(1_000),
		PetersburgBlock:     nil,
		DarvazaBlock:        big.NewInt(2_000),
		DarvazaDefaultGas:   new(big.Int).SetUint64(2_000 * Shannon),
		HafthorBlock:        big.NewInt(3_000),
