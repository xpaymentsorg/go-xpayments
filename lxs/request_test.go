...
func TestBlockAccessLxs1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }
...
func TestReceiptsAccessLxs1(t *testing.T) { testAccess(t, 1, tfReceiptsAccess) }
...
func TestTrieEntryAccessLxs1(t *testing.T) { testAccess(t, 1, tfTrieEntryAccess) }
...
func TestCodeAccessLxs1(t *testing.T) { testAccess(t, 1, tfCodeAccess) }
