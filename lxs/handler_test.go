...
func TestGetBlockHeadersLxs1(t *testing.T) { testGetBlockHeaders(t, 1) }
...
func TestGetBlockBodiesLxs1(t *testing.T) { testGetBlockBodies(t, 1) }
...
func TestGetCodeLxs1(t *testing.T) { testGetCode(t, 1) }
...
func TestGetReceiptLxs1(t *testing.T) { testGetReceipt(t, 1) }
...
func TestGetProofsLxs1(t *testing.T) { testGetProofs(t, 1) }
...
func TestGetCHTProofsLxs1(t *testing.T) { testGetCHTProofs(t, 1) }
...
func TestTransactionStatusLxs2(t *testing.T) {
	db := xpsdb.NewMemDatabase()
