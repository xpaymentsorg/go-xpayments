...
func TestOdrGetBlockLxs1(t *testing.T) { testOdr(t, 1, 1, odrGetBlock) }

func TestOdrGetBlockLxs2(t *testing.T) { testOdr(t, 2, 1, odrGetBlock) }
...
func TestOdrGetReceiptsLxs1(t *testing.T) { testOdr(t, 1, 1, odrGetReceipts) }

func TestOdrGetReceiptsLxs2(t *testing.T) { testOdr(t, 2, 1, odrGetReceipts) }
...
func TestOdrAccountsLxs1(t *testing.T) { testOdr(t, 1, 1, odrAccounts) }

func TestOdrAccountsLxs2(t *testing.T) { testOdr(t, 2, 1, odrAccounts) }
...
func TestOdrContractCallLxs1(t *testing.T) { testOdr(t, 1, 2, odrContractCall) }

func TestOdrContractCallLxs2(t *testing.T) { testOdr(t, 2, 2, odrContractCall) }
...
func testOdr(t *testing.T, protocol int, expFail uint64, fn odrTestFn) {
	...
	ldb := xpsdb.NewMemDatabase()
	odr := NewLxsOdr(ldb, light.NewChtIndexer(db, true), light.NewBloomTrieIndexer(db, true), xps.NewBloomIndexer(db, light.BloomTrieFrequency), rm)
