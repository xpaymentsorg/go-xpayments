...
func New(ctx context.Context, sctx *node.ServiceContext, config *eth.Config) (*LightXPS, error) {
...
func (s *LightXPS) LesVersion() int                    { return int(s.protocolManager.SubProtocols[0].Version) }
