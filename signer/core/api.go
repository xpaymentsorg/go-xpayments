...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*xpsapi.SignTransactionResult, error)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*xpsapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := xpsapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
