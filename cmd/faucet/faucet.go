...
var (
	...
	berylliumFlag = flag.Bool("beryllium", false, "Initializes the faucet with Görli network config")
)
...
func main() {
	...
	genesis, err := getGenesis(*genesisFlag, *berylliumFlag)
	if err != nil {
...
func getGenesis(genesisFlag string, berylliumFlag bool) (*core.Genesis, error) {
	switch {
	case genesisFlag != "":
